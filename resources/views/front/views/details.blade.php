...
@section('title', 'Moust Famous Fundraisings Indonesia')
@section('content')
<section class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-white overflow-x-hidden">
                ...
                @forelse($fundraising->donaturs as $donatur)
                  <div class="flex items-center gap-3">
                      ...
                      <div class="flex flex-col gap-[2px] w-full">
                          ...
                          <p class="caption text-xs leading-[18px] text-[#66697A]">{{$donatur->name}}</p>
                      </div>
                  </div>
                  @empty
  ...
  {{-- jika target amount belum tercapai maka masih bisa meenerima donasi --}}
  @if(!$goalReached)
