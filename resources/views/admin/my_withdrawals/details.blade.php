            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="flex flex-row gap-x-16">
                    ...
                    <div>
                        ...
                        <h3 class="text-indigo-950 text-xl font-bold">{{ $fundraisingWithdrawal->fundraising->category->name }}</h3>
                ...
                <div class="flex flex-row gap-x-10">    
                    ...
                    <div>
                        ...
                        <h3 class="text-indigo-950 text-xl font-bold">{{ $fundraisingWithdrawwal->bank_account_name }}</h3>
                    </div>
                </div>
                <hr class="my-5">
                <h3 class="text-indigo-950 text-xl font-bold mb-5">Pengiriman berhasil</h3>
