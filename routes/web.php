...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/my_withdrawals/details/{fundraisingWithdrawals}', [DashboardController::class, 'my_withdrawals'])->name('my_withdrawals.details');
        
      
    

    });
}); // middleware dan auth ( halaman ini tidak bisa di kunjungi kecuali sudah login )
